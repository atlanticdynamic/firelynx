...
func TestTomlLoader_MultipleRouteTypes(t *testing.T) {
	...
	for i, route := range endpoint.Routes {
		...
		// TODO: Check if it's a gRPC route when gRPC support is re-enabled
	...
	// TODO: Re-enable when gRPC support is added back
...
func TestRouteDuplication(t *testing.T) {
	...
	// TODO: Make sure there's no grpc field populated when gRPC support is re-enabled
